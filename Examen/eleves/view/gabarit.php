...
*  File: page gabarit.php gabarit du site
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <?php if (@$_GET['action'] == "login") : ?>
                        ...
                        <?php if (isset($_SESSION['login'])) : ?>
                            <a href="index.php?action=logout"><img src="model/dataStorage/avatars/<?= $_SESSION['avatarimg'] ?>" class="avatar"
                                                                   alt=""> - Logout</a></li>
                        <?php else: ?>
                    ...
                    <?php endif; ?>
                    <li role="presentation"><a href="/?action=contacts">Contact</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 f-about">
                    ...
                    <p>Le site idéal pour vendre tous vos vieux livres d'école que vous n'utilisez plus et si vous
                        poursuivez vos études vous pouvez trouver des livres d'occasion à bon prix</p>
                </div>
